...
def connector_status(
    ...
    return {
        "quickbooks": any(c.connector_type == "quickbooks" for c in connectors),
        "xero": any(c.connector_type == "xero" for c in connectors),
        "zoho": any(c.connector_type == "zoho" for c in connectors),
        "tally": any(c.connector_type == "tally" for c in connectors),
    }
